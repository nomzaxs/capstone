...
import com.example.capstone.SharedPrefManager;
import com.example.capstone.services.MyService;
...
//start iv_cam
    ...
    private boolean isAccessibilityEnabled() {
        ...
        final String ACCESSIBILITY_SERVICE = requireContext().getApplicationContext().getPackageName() + "/" + MyService.class.getCanonicalName();
